(function(){
  var httpServer, sockjsServer, connection, config, serializeMessage, unserializeMessage, DEBUG, debug, error, fs, http, sockjs, _, onFileChange, EventEmitter2, allEvents, Event, injectedUrl, clientPath, commonCodePath, createClient, isOpened, lastId, connections, self;
  config = {
    bindIp: '0.0.0.0',
    host: 'localhost',
    port: 9999
